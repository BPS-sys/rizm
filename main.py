...
def draw_score(screen, score, combo, max_combo, great, good, miss):
    ...
    max_combo_text = font.render("MaxCombo: " + str(max_combo), True, (255, 0, 0))    
    screen.blit(max_combo_text, (10, 30))
    great_text = font.render("Great: " + str(great), True, (255, 102, 0))    
    screen.blit(great_text, (10, 50))
    good_text = font.render("Good: " + str(good), True, (0, 255, 102))    
    screen.blit(good_text, (10, 70))
    miss_text = font.render("Miss: " + str(miss), True, 200)
